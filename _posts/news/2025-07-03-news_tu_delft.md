...
{% include figure.html image="images/news/250703_tu_delft/TU_delft_1.jpg" width="80%" %}
</div>
...
<div style="display: flex; gap: 20px; justify-content: center; flex-wrap: wrap; margin-top: 1em; margin-bottom: 1em;">
{% include figure.html image="images/news/250703_tu_delft/TU_delft_3.jpg" width="100%" %}
{% include figure.html image="images/news/250703_tu_delft/TU_delft_4.jpg" width="100%" %}
</div>
...
<div style="display: flex; gap: 20px; justify-content: center; flex-wrap: wrap; margin-top: 1em; margin-bottom: 1em;">
{% include figure.html image="images/news/250703_tu_delft/TU_delft_2.jpg" width="80%" %}
</div>
