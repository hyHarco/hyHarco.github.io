...
{% include tags.html tags="Physical Human-Robot Collaboration , Occupational Ergonomics, Human Modelling,
...
{%
  ...
  org_name="Luka Peternel, Assistant Professor"
...
{%
  ...
  org_name="Wansoo Kim, Assistant Professor"
...
{%
  ...
  org_name="Heni Ben Amor, Associate Professor"
...
{%
  ...
  org_name="Arash Ajoudani, Principal Investigator"
...
{%
  ...
  org_name="Eiichi Yoshida, Professor"
...
{%
  ...
  speakername="Serena Ivaldi (INRIA, France)"
...
{%
  include invited_speaker.html
  speakername="Tadej Petrič (Jožef Stefan Institute, Slovenia)"
...
{%
  include invited_speaker.html
  speakername="Bram Vanderborght (Vrije Universiteit Brussel, Belgium)"
...
{%
  include invited_speaker.html
  speakername="Dorsa Sadigh (Stanford University, USA)"
...
{%
  include invited_speaker.html
  speakername="Xu Xu (North Carolina State University, USA)"
...
{%
  include invited_speaker.html
  speakername="Gentiane Venture (University of Tokyo, Japan)"
  spekerlink="https://members.loria.fr/SIvaldi/"
  headline="Title"
